...
public:
    ...
    eT _imag;
    Complex();
    Complex(eT real, eT imag);

    Complex operator+(const Complex &other) const;
    Complex operator-(const Complex &other) const;
    Complex operator*(const Complex &other) const;

    Complex operator+(const eT &other) const;
    Complex operator-(const eT &other) const;
    Complex operator*(const eT &other) const;

    // eT data + Complex
    friend Complex operator+(const eT &data, const Complex &other) {
        return Complex(data + other._real, other._imag);
    }
    ...
    // eT data * Complex
    friend Complex operator*(const eT &data, const Complex &other) {
        return Complex(data * other._real, data * other._imag);
    }
...
template<typename eT>
Complex<eT>::Complex() : _real(0), _imag(0) {}

template<typename eT>
Complex<eT>::Complex(eT real, eT imag) : _real(real), _imag(imag) {}

template<typename eT>
Complex<eT> Complex<eT>::operator+(const Complex &other) const {
...
template<typename eT>
Complex<eT> Complex<eT>::operator+(const eT &other) const {
