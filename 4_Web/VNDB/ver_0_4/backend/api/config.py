...
class Config:
    ...
    SAVEDATA_FOLDER = os.environ.get('SAVEDATA_FOLDER', os.path.join(os.path.dirname(__file__), 'savedatas'))
    BACKUP_FOLDER = os.environ.get('BACKUP_FOLDER', os.path.join(os.path.dirname(__file__), 'backups'))
