...
export default function DoctorManagementPage() {
  ...
  useEffect(() => {
    fetchDoctors(page, currentQuery)
                    ...
                    <form onSubmit={(e) => {
                      ...
                      <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                          ...
                          <Input id="edit-email" name="email" type="email" defaultValue={editingDoctor?.email} className="col-span-3" required />
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
                          <Label htmlFor="edit-phone_number" className="text-right">
                            Phone Number
                          </Label>
                          <Input id="edit-phone_number" name="phone_number" defaultValue={editingDoctor?.phone_number} className="col-span-3" required />
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
