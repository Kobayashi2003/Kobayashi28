...
global asm_atomic_test_and_set
...
asm_atomic_test_and_set:
    ...
    and  eax, 0xFF          ; clear 31-8 bits of eax
    mov  ebx, [ebp + 4 * 2] ; memory 

    lock bts dword [ebx], 0 ; set bit 0 of [ebx] to 1, and return the old value to CF
    setc al                 ; if CF == 1, set al to 1, otherwise set al to 0
