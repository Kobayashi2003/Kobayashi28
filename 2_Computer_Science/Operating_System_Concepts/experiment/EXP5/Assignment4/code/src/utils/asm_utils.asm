...
extern c_time_interrupt_handler_RoundRobinScheduler
extern c_time_interrupt_handler_FirstComeFirstServedScheduler

extern c_time_interrupt_handler_PriorityScheduler
...
asm_time_interrupt_handler:
    ...
    ; call c_time_interrupt_handler_RoundRobinScheduler
    ; call c_time_interrupt_handler_FirstComeFirstServedScheduler
    call c_time_interrupt_handler_PriorityScheduler
