	    ...
	    <li class="process-doing clearfix">
	        ...
	        <div class="step-text">
	            ...
	            <div class="mt10 mb20 wm lh2">
					...
					${ _("（1）根据【开发者中心-文档与支持-新手入门】相关文档配置开发环境")}<br>
					${ _("（2）config/dev.py 文件：DATABASES（请创建本地开发数据库，并修改配置信息）")}<br>
					${ _("（3）config/stag.py 文件：DATABASES（请创建测试数据库，并修改配置信息）")}<br>
					${ _("（4）config/prod.py 文件：DATABASES（请创建正式数据库，并修改配置信息）")}<br>
